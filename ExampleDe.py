...
# regularized logistic regression is used
import os
import csv
import re
import logging
...
if __name__ == '__main__':
    ...
    output_file = '/home/binbingu/Downloads/dedupe/data_matching_output.csv'
    settings_file = '/home/binbingu/Downloads/dedupe/data_matching_learned_settings'
    training_file = '/home/binbingu/Downloads/dedupe/data_matching_training.json'

    left_file = '/home/binbingu/Downloads/dedupe/5000-1.csv'
    #left_file = '/home/binbingu/Downloads/dedupe/10000-1.csv'
    
    right_file = '/home/binbingu/Downloads/dedupe/5000-2.csv'
    #right_file = '/home/binbingu/Downloads/dedupe/10000-2.csv'

    #print('importing data ...')
    data_1 = readData(left_file)
    #print(list(data_1.items())[:5])
    ...
    if os.path.exists(settings_file):
        ...
        fields = [
            ...
            {'field': ' culture', 'type': 'Exact', 'has missing': True},
            ]
        # fields = [
    ...
    #print('clustering...')
    linked_records = linker.join(data_1, data_2, 0.85)
